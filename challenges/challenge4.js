 ...
 *  It will return a single promise. This promise's resolved value will be an array containing the resolved values of each promise from the argument array.
 *
...
Promise.all([person1Promise, person2Promise, person3Promise, planet1Promise])
    .then(function(results) {
        ...
        console.log(`Planet's name: ${results[3].name}`)
    })
    .catch(function(err) {
        console.log('Got an error!')
        console.log(err)
